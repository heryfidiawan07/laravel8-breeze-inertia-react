            ...
            <form className="form-inline mr-auto">
                ...
                <div className="search-element">
                    ...
                    <div className="search-result">
                        ...
                        <div className="search-item">
                            <a href="#">
                            <img className="mr-3 rounded" width="30" src="http://localhost:8000/assets/img/products/product-3-50.png" alt="product"/>
                            oPhone S9 Limited Edition
                            </a>
                        </div>
                        <div className="search-item">
                            <a href="#">
                            <img className="mr-3 rounded" width="30" src="http://localhost:8000/assets/img/products/product-2-50.png" alt="product"/>
                            Drone X2 New Gen-7
                            </a>
                        </div>
                        <div className="search-item">
                            <a href="#">
                            <img className="mr-3 rounded" width="30" src="http://localhost:8000/assets/img/products/product-1-50.png" alt="product"/>
                            Headphone Blitz
                            </a>
                        </div>
                        <div className="search-header">
            ...
            <ul className="navbar-nav navbar-right">
                        ...
                        <div className="dropdown-list-content dropdown-list-message">
                            <a href="#" className="dropdown-item dropdown-item-unread">
                                <div className="dropdown-item-avatar">
                                    <img alt="image" src="http://localhost:8000/assets/img/avatar/avatar-1.png" className="rounded-circle"/>
                            ...
                            <a href="#" className="dropdown-item dropdown-item-unread">
                                <div className="dropdown-item-avatar">
                                    <img alt="image" src="http://localhost:8000/assets/img/avatar/avatar-2.png" className="rounded-circle"/>
                                </div>
                                <div className="dropdown-item-desc">
                                    <b>Dedik Sugiharto</b>
                            ...
                            <a href="#" className="dropdown-item dropdown-item-unread">
                                <div className="dropdown-item-avatar">
                                    <img alt="image" src="http://localhost:8000/assets/img/avatar/avatar-3.png" className="rounded-circle"/>
                                    <div className="is-online"></div>
                                </div>
                                <div className="dropdown-item-desc">
                            ...
                            <a href="#" className="dropdown-item">
                                <div className="dropdown-item-avatar">
                                    <img alt="image" src="http://localhost:8000/assets/img/avatar/avatar-4.png" className="rounded-circle"/>
                                </div>
                                <div className="dropdown-item-desc">
                            ...
                            <a href="#" className="dropdown-item">
                                <div className="dropdown-item-avatar">
                                    <img alt="image" src="http://localhost:8000/assets/img/avatar/avatar-5.png" className="rounded-circle"/>
                                </div>
                                <div className="dropdown-item-desc">
                                    <b>Alfa Zulkarnain</b>
                ...
                <li className="dropdown">
                    <a href="#" data-toggle="dropdown" className="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        <img alt="image" src="http://localhost:8000/assets/img/avatar/avatar-1.png" className="rounded-circle mr-1"/>
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="#" className="dropdown-item has-icon text-danger" onClick={submit}>
