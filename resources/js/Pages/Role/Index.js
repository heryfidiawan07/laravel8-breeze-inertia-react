...
const tableHeader = [
    ...
    {'name': 'permissions', 'as': 'Permissions', 'order': true},
    {'name': 'created_at', 'as': 'Created_at', 'order': true},
...
export default function Index(props) {
    ...
    const destroy = async (id, reload, params) => {
        ...
        await SwallRequest(route('role.destroy', id), data, {'reload':reload, 'params':params})
    }
        ...
        return(
            <React.Fragment>
                <button 
                    ...
                    onClick={() => Inertia.get(route('role.edit', row.id))}
                >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white p-6 rounded-lg shadow-xl">
                        <div className="p-6 bg-white border-b border-gray-200 mb-5">
                            Role Data
                            <Link href={route('role.create')} className="bg-blue-500 hover:bg-blue-700 text-white text-sm font-semibold py-2 px-3 rounded float-right">
                                Create Role
                            </Link>
                        </div>
